         ...
         while ((!Network.getClientConnectionStatus().equals("disconnected")))
         {
        	 ...
        	 { 
                 ...
                 try {
                    ...
                    System.out.println("Error while transferring in: " + e.getMessage());
                    Thread.currentThread().interrupt(); // Restore the interrupted status
                    continue; // Skip this iteration if an interruption occurs
                }
                 ...
                 try {
                    ...
                    System.out.println("Error while transferring out: " + e.getMessage());
                    Thread.currentThread().interrupt(); // Restore the interrupted status
                    continue; // Skip this iteration if an interruption occurs
                }
