...
public class Network extends Thread {
    ...
    static Semaphore full_1 = new Semaphore(0);
    static Semaphore mutex_1 = new Semaphore(1);
    static Semaphore empty_1 = new Semaphore(10);
    static Semaphore full_2 = new Semaphore(0);
    static Semaphore mutex_2 = new Semaphore(1);
    static Semaphore empty_2 = new Semaphore(10);
    ...
    public static boolean transferIn(Transactions inPacket) throws InterruptedException
    {
      ...
      setoutputIndexServer(((getoutputIndexServer() + 1) % getMaxNbPackets()));	
       if ( getoutputIndexServer( ) == getinputIndexClient( )) {setInBufferStatus("empty");}
